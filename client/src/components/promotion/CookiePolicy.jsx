            ...
            <div className="card-body">
                ...
                <ul>
                    <li>
                        ...
                        Cookies Policy) refers to Paste Library.
                    </li>
                    <li>
                    ...
                    <li>
                        <strong>Website</strong> refers to Paste Library, accessible from http://pastelibrary.tk/.
                    </li>
                </ul>
                ...
                <ul>
                    <li>By email: contact@pastelibrary.tk</li>
                </ul>
            </div>
        </div>
    );
